...
<div style="text-align:center">
  ...
  <div class="o" id="o">
      ...
      <div data-code="mx" data-name="Mexico">
        ...
        <input id="user" type="text" placeholder="username" value="ROYAL QUOTEX TRADER" /><br>
        ...
        <label for="win__all">WIN ALL</label>
        <input id="win__all" type="text" placeholder="YES or NO" value="YES" /><br>
        <label for="win__perc">PERCENT</label>
        <input id="win__perc" type="text" placeholder="win percentage" value="94" /><br>
        <br>
        </div>
        <div style="text-align: center;">
            <button
        ...
        myDialog.querySelector("button").addEventListener("click", () => {
            if (document.querySelector("#win__all").value.toLowerCase() == "yes") {
                ...
                trades.forEach(element => {
                    ...
                    const res = parseFloat(money.innerText.split(" ")[0].replace(",", "")) * (1 + (Number(document.querySelector("#win__perc").value) / 100));
...
// Remove any dialogs
            ...
            // CHANGE MAIN DEMO
            document.querySelector(".---react-features-Usermenu-styles-module__demo--TmWTp").innerText = "live account";
            ...
            carret.onclick = function () {
                if (state__carret) {
                    (function exists() {
                        var el = document.querySelector("div.---react-features-Usermenu-Dropdown-styles-module__dropdown--AishB.---react-features-Usermenu-Dropdown-styles-module__active--P5n2A");
                        if (!el) {
                            return setTimeout(exists)
                        }
                        DROPDOWN()
